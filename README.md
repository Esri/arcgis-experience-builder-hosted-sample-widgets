...
2. Use the widget manifest path as the below format:
   ...
   [https://esri.github.io/arcgis-experience-builder-hosted-sample-widgets/[widget manifest path]](https://esri.github.io/arcgis-experience-builder-hosted-sample-widgets/[widget manifest path])
